...
public class NonPlayerCharacter extends Characters{
    ...
    public NonPlayerCharacter(WorldTile tile, float x, float y, String tempName) {
        super(tile, x, y);
    ...
    public void talk(){
        ...
        else System.out.println("I'm at " + getY() + ", " + getX());
    }

    public void walk(){
        if (Math.random() > 0.95){
            adjustX(MathUtils.random(-50,50));
            adjustY(MathUtils.random(-50,50));
        }
    }
}
